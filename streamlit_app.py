...
st.title("The Airbnb dataset of Amsterdam : Tip Prediction")
st.markdown(
    "The dataset contains modifications with regards to the original for illustrative & learning purposes"
)

st.text("This widget can be used by hosts to predict their expected tips per listing.")

# review_scores_rating: 0 to 5
review_scores_rating = st.slider('What rating is your listing?', 0.00, 5.00, 4.50)
...
instant_bookable = st.radio(
    "Is your listing instantly bookable?",
    ("True", "False"))
